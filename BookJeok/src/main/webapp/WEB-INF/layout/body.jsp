					...
					<div class="product-info">
						<div class="nav-main">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#man" role="tab">전체</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#women" role="tab">시/에세이</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#kids" role="tab">인문/교양</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">자연과학/공학</a>
								</li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#essential" role="tab">컴퓨터/IT</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#prices" role="tab">유아/어린이</a></li>
							</ul>
							<!--/ End Tab Nav -->
						</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							<p>Influencer pick</p>
							<h3>구독자 150만의 <br>독서 유튜버가 고른 신간 도서는?</br> </h3>
							<a href="#" class="btn">Shop Now</a>
						</div>
					</div>
				</div>
