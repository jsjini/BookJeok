					...
					<div class="col-lg-7 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<c:choose>
									<c:when test="${empty logId }">
										<li><a class="login" data-toggle="modal" data-target="#loginModal" href="#">로그인</a>
										<li>
										<li><a class="join" data-toggle="modal" data-target="#joinModal" href="#">회원가입</a>
										<li>
									</c:when>
									<c:otherwise>
					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar">
								<a href="likeIt.do?memberNo=1" class="single-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							</div>
							<!-- 마이페이지 아이콘 -->
							<div class="sinlge-bar">
