	...
	<section class="mt-8">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<!-- img -->
					${vo.img} ${vo.name} ${vo.author} ${vo.comp} ${vo.price} ${vo.dt}
					${vo.category} ${vo.about}
				</div>
				<!-- 우측 정보 -->
				<div class="col-md-6">
					<div class="ps-lg-10 mt-6 mt-md-0">
						...
						<div class="position-absolute top-50 start-50 translate-middle">
							<div class="mt-3 row justify-content-start g-2 align-items-center position-absolute top-50 start-50 translate-middle">
								<h1>
									<span class="txt_main">${vo.name}</span>
								</h1>
							</div>
						</div>
					</div>
				...
				<ul class="nav nav-pills nav-lb-tab" id="myTab" role="tablist">
					...
					<li class="nav-item" role="presentation">
						...
						<button class="nav-link active" id="product-tab"
							...
							aria-selected="true" tabindex="-1">상세정보</button>
					</li>
					<!-- nav item : (리뷰 탭) -->
					<li class="nav-item" role="presentation">
						<!-- btn -->
					...
					<div class="tab-pane fade show active" id="product-tab-pane"
						...
						<div class="my-8">
							...
							<div class="mb-5">
								...
								<p class="mb-0">Nisi, tellus iaculis urna bibendum in lacus,
									integer. Id imperdiet vitae varius sed magnis eu nisi nunc sit.
									Vel, varius habitant ornare ac rhoncus. Consequat risus
									facilisis ante ipsum netus risus adipiscing sagittis sed.Lorem
							...
							<div>
								...
								<p class="mb-0">Image shown is a representation and may
									slightly vary from the actual product. Every effort is made to
									maintain accuracy of all information displayed.</p>
							</div>
						</div>
					</div>
					<!-- tab pane -->
								...
								<div class="col-md-8">
									<div class="mb-10">
										...
										<div class="d-flex border-bottom pb-6 mb-6 pt-4">
											...
											<div class="ms-5">
												...
												<p>Everytime i ordered from fresh i got greenish yellow
													bananas just like i wanted so go for it , its happens very
													rare that u get over riped ones.</p>
										...
										<div class="d-flex border-bottom pb-6 mb-6 pt-4">
											...
											<div class="ms-5 flex-grow-1">
												...
												<p>Great product &amp; package. Delivery can be
													expedited.</p>
									...
									<div>
										...
										<div class="border-bottom py-4 mb-4">
											...
											<div class="rater star-rating"
												style="width: 100px; height: 20px; background-size: 20px;">
												<div class="star-value"
													style="background-size: 20px; width: 0px;"></div>
											</div>
										</div>
										<div class="border-bottom py-4 mb-4">
										...
										<div class="border-bottom py-4 mb-4">
											...
											<p>Shoppers find images and videos more helpful than text
												alone.</p>

											<div id="my-dropzone"
												class="dropzone mt-4 border-dashed rounded-2 min-h-0 dz-clickable">
