					...
					<div class="nav-main">
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							...
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#women" role="tab">시/에세이</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#kids" role="tab">인문/교양</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#accessories" role="tab">자연과학/공학</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#essential" role="tab">컴퓨터/IT</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#prices" role="tab">유아/어린이</a></li>
						</ul>
						<!--/ End Tab Nav -->
					</div>
